...
from metabolights.models.isa.common import IsaTableFile
from metabolights.models.isa.investigation_file import Investigation
from metabolights.models.parser.common import ParserReport
...
class InvestigationFileReader(ABC):
    ...
    def read(
        ...
        Args:
            file_buffer_or_path (str, pathlib.Path, IOBase): File buffer to read file content. io.StringIO, io.TextIOWrapper with open(), etc. Defaults to None.
