...
class MockFtpWriter:
    ...
    def cwd(self, current_path: str):
        relative_path = current_path.removeprefix(self.remote_root_directory).strip("/")
...
def test_download_study_data_files_01(mocker: MockerFixture):
    ...
    try:
        ...
        print(str(ex))
        assert False, "Error while testing download_study_data_files"
    finally:
        shutil.rmtree(local_path, ignore_errors=True)
...
def test_download_study_metadata_files_01(mocker: MockerFixture):
    ...
    try:
        ...
        print(str(ex))
        assert False, "Error while testing download_study_metadata_files_01"
    finally:
        shutil.rmtree(local_path, ignore_errors=True)
...
def test_download_study_metadata_files_02(mocker: MockerFixture):
    ...
    try:
        ...
        print(str(ex))
        assert False, "Error while testing test_download_study_metadata_files_02"
    finally:
        shutil.rmtree(local_path, ignore_errors=True)
...
def test_list_studies_01(mocker: MockerFixture):
    ...
    try:
        ...
        print(str(ex))
        assert False, "Error while testing list_studies_01"
...
def test_list_study_folder_directory_01(mocker: MockerFixture):
    ...
    try:
        ...
        print(str(ex))
        assert False, "Error while testing test_list_study_folder_directory_01"
