...
@pytest.mark.asyncio
async def test_load_study_data_02(study_id, study_path):
    provider = AsyncMetabolightsStudyProvider()
    model: MetabolightsStudyModel = await provider.load_study(
        study_id,
        study_path,
...
@pytest.mark.parametrize("study_id,study_path", test_studies)
@pytest.mark.asyncio
async def test_load_study_data_03(study_id, study_path):
    provider = AsyncMetabolightsStudyProvider()
    model: MetabolightsStudyModel = await provider.load_study(
        study_id,
        study_path,
...
@pytest.mark.asyncio
async def test_load_study_data_04(study_id, study_path):
...
@pytest.mark.asyncio
async def test_load_study_data_with_provider_01(study_id, study_metadata_root_path):
